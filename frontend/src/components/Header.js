          ...
          <div class="row align-items-center">
            ...
            <div className='col-5'>
              <div class="input-group">
                ...
                <span class="input-group-text px-3" id="basic-addon2"><BsSearch className='fs-6' /></span>
              </div>
            </div>
            <div className='col-5'>
              ...
              <div className='menu-bottom d-flex align-items-center gap-30'>
                ...
                <div className='menu-links'>
                  <div className='d-flex align-items-center gap-15'>
                    ...
                    <NavLink className='text-white' to='/home'>Our Store</NavLink>
                    <NavLink className='text-white' to='/home'>Blogs</NavLink>
                    <NavLink className='text-white' to='/home'>Contact</NavLink>
                  </div>
                </div>
              </div>
            </div>
